...
- Teknisi dan kepala laboratorium aktif menjadi manager hanya untuk laboratoriumnya sendiri.
...
| `can_manage_report(uuid)` | Manager lab report; reporter tidak otomatis menjadi manager |
...
|---|---|---|---|---|---|---|---|
| Read/manage report A | Global | Ya | Tidak | Ya | Tidak | Own only | Own only |
| Read/manage report B | Global | Tidak | Ya | Tidak | Ya | Own only | Own only |
| Insert follow-up A/B | Global | A saja | B saja | A saja | B saja | Tidak | Tidak |
